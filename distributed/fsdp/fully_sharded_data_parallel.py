...
class FullyShardedDataParallel(nn.Module):
    ...
    def _set_is_root(self) -> None:
        ...
        for n, m in self.named_modules():
            ...
            if n != "" and isinstance(m, FullyShardedDataParallel):
                # We relax the assets for non-root instance, when the nested initialized module is wrapped
    ...
    def _register_pre_backward_hooks(self, outputs: Any) -> Any:
        ...
        if self._is_root:
            ...
            # will assets on all other instances, giving us a nice bug checker.
    ...
    def _assert_state(self, state: Union[TrainingState_, List[TrainingState_]]) -> None:
        ...
        # Since assets can be turned off and this error checking
